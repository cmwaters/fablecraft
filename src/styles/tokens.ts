...
function buildCssVariables(preferences: UiPreferences): CssVariableMap {
  ...
  return {
    ...
    "--fc-font-ui": fonts.ui,
    "--fc-layer-base": uiTokens.layerColors.neutral,
    "--fc-layer-blue": uiTokens.layerColors.blue,
    "--fc-layer-green": uiTokens.layerColors.green,
    "--fc-layer-orange": uiTokens.layerColors.orange,
    "--fc-layer-purple": uiTokens.layerColors.purple,
    "--fc-layer-red": uiTokens.layerColors.red,
    "--fc-layer-yellow": uiTokens.layerColors.yellow,
